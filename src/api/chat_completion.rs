...
pub struct ChatCompletionRequest {
    ...
    /// Just like tool_choice but specifying a particular function via {"type: "function", "function": {"name": "my_function"}} forces the model to call that function.
    #[builder(default, setter(strip_option))]
...
pub struct SpecifiedToolChoice {
    r#type: String,
...
mod tests {
    ...
    fn chat_completion_request_tool_choice_function_serialize_should_work() {
        let req = ChatCompletionRequestBuilder::default()
            .tool_choice_force(SpecifiedToolChoice {
